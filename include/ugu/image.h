...
using Image1d = cv::Mat1d;
using Image2b = cv::Mat2b;
using Image2w = cv::Mat2w;
using Image2i = cv::Mat2i;
using Image2f = cv::Mat2f;
using Image2d = cv::Mat2d;
using Image3b = cv::Mat3b;
using Image3w = cv::Mat3w;
using Image3i = cv::Mat3i;
using Image3f = cv::Mat3f;
using Image3d = cv::Mat3d;
using Image4b = cv::Mat4b;
using Image4w = cv::Mat4w;
using Image4i = cv::Mat4i;
using Image4f = cv::Mat4f;
using Image4d = cv::Mat4d;

using Vec2b = cv::Vec2b;
using Vec2w = cv::Vec2w;
using Vec2i = cv::Vec2i;
using Vec2f = cv::Vec2f;
using Vec2d = cv::Vec2d;
using Vec3b = cv::Vec3b;
using Vec3w = cv::Vec3w;
using Vec3i = cv::Vec3i;
using Vec3f = cv::Vec3f;
using Vec3d = cv::Vec3d;
using Vec4b = cv::Vec4b;
using Vec4w = cv::Vec4w;
